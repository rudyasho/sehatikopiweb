...
export const metadata: Metadata = {
  ...
  keywords: ['kopi arabika', 'jual kopi arabika', 'biji kopi arabika', 'kopi indonesia', 'single origin coffee', 'roastery jakarta', 'kedai kopi', 'kopi robusta'],
  authors: [{ name: 'Sehati Kopi Digital' }],
  openGraph: {
    title: 'Sehati Kopi Digital - Kopi Arabika & Robusta Terbaik Indonesia',
    description: 'Temukan kekayaan rasa kopi arabika dan robusta dari seluruh nusantara.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Secangkir kopi dengan biji kopi tersebar',
      },
    ],
    locale: 'id_ID',
    type: 'website',
