...
import { Coffee, Star, Calendar, Newspaper, Loader2, List, PlusCircle, Upload, Link as LinkIcon, Edit, BarChart3, Settings } from 'lucide-react';
            ...
            <aside className="lg:col-span-1 space-y-8 lg:sticky lg:top-24">
                 <Card className="shadow-lg bg-background">
                    <CardHeader>
                        ...
                        <CardDescription>Manage your products and blog posts.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="blog-generator">
                                <AccordionTrigger className="text-base font-semibold">AI Blog Post Generator</AccordionTrigger>
                                <AccordionContent className="pt-4">
                                    <BlogPostGenerator onPublish={handlePublishPost} />
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="add-product">
                                <AccordionTrigger className="text-base font-semibold">Add New Product</AccordionTrigger>
                                <AccordionContent className="pt-4">
                                     <AddProductForm />
                                </AccordionContent>
                            </AccordionItem>
